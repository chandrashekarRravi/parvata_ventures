  ...
  return (
    <div className="group bg-surface-container-low p-2 rounded-lg border border-outline-variant hover:border-primary transition-colors duration-500 fade-in-up">
      ...
      <div className="px-4 pb-4">
        ...
        <Link href={service.href} className="inline-flex items-center gap-2 text-primary font-label-sm text-label-sm uppercase tracking-widest hover:opacity-80 transition-opacity">
